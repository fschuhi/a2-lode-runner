...
| `web/style.css`  | `web/style.css`  | NOTE comment added; rule added that shrinks images to the width of the reading column; rules added for the sprite pixel grids and the sprite catalog of Chapter 3, and for the level catalog of Chapter 6 |
