...
***********************************************************************************
NOTE: Copy of `weave.py` from XekriRedmane's `lode_runner_reveng`
(`reference/lode_runner_reveng/weave.py`; see `scripts/PROVENANCE.md`),
renamed to distinguish it from the newer Ultima `weave.py`. Only this NOTE
