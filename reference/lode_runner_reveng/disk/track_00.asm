...
; Track $00, sector $0
    ...
    HEX     B6 D0 F6 AD CB B5 48 AD CC B5 48 AD C3 B5 8D CB
    HEX     B5 AD C4 B5 8D CC B5 AD C2 B5 D0 08 AD C1 B5 F0
    HEX     14 8D 3D BE 20 B6 B0 20 99 B1 CE C2 B5 EE C4 B5
    HEX     AD 3D BE F0 D6 A9 00 8D 3D BE 68 8D CC B5 68 8D
    HEX     CB B5 60 00 00 00 00 00 00 00 00 00 00 00 B6 09
...
; Track $00, sector $1
    ...
    HEX     B7 20 93 FE 20 89 FE 4C 84 9D AD E7 B7 38 ED F1
    ...
    HEX     1B 02 0A 1B E8 B7 00 B6 01 60 02 FE 00 01 FB B7
    HEX     00 B7 00 00 02 03 FE 60 02 00 00 00 01 EF D8 00
...
; Track $00, sector $4
    ...
    HEX     F6 F7 F9 FA FB FC FD FE FF 20 B5 B1 20 A8 AC 48
    HEX     20 A2 B1 A0 00 68 91 42 4C 96 AC C5 AA A0 82 B3
...
; Track $00, sector $5
    HEX     01 0A 11 0A 08 20 20 0E 18 06 02 31 02 09 08 27
    HEX     22 00 12 0A 0A 04 00 00 03 2A 00 04 08 00 22 08
    HEX     10 20 12 02 00 02 08 11 0A 08 02 28 11 01 39 22
    ...
    HEX     3F 27 23 30 37 23 30 12 1A 08 30 2F 08 30 2F 27
    HEX     23 30 37 23 30 3A 22 34 3C 2A 35 08 35 2F 2A 2A
    HEX     08 35 2F 2A 25 08 35 2F 29 10 08 31 2F 29 11 08
    HEX     31 2F 29 0F 08 31 2F 29 10 11 11 11 0F 12 12 01
    HEX     0F 27 23 30 2F 23 30 1A 02 2A 08 35 2F 2A 37 08
    HEX     35 2F 2A 2A 08 35 2F 2A 3A 08 35 2F 06 2F 23 30
    HEX     2F 23 30 18 12 12 01 0F 27 23 30 37 23 30 1A 3A
    HEX     3A 3A 02 2A 3A 3A 12 1A 27 23 30 37 23 30 18 22
    HEX     00 00 02 01 01 02 25 3A 24 28 25 22 25 24 24 32
    HEX     25 34 25 24 24 32 25 34 25 24 28 32 28 29 21 29

; Track $00, sector $6
    HEX     10 A1 45 28 21 82 80 38 62 19 0B C5 0B 24 21 9C
    HEX     88 00 48 28 2B 10 00 03 0C A9 01 10 21 00 88 22
    HEX     40 80 48 09 01 08 21 44 29 22 08 A0 45 06 E4 8A
    HEX     C4 06 16 60 80 A0 09 40 18 0A 24 0A 16 B0 43 00
    HEX     20 BB 00 14 08 A0 60 0A C0 8F 0A 83 CA 11 44 08
    HEX     51 0A 20 26 4A 80 38 BD 8D C0 BD 8E C0 30 5E A9
    ...
    HEX     00 00 09 04 04 09 96 E8 91 A0 94 88 96 91 91 C8
...
; Track $00, sector $8
    ...
    HEX     A5 2D D0 F1 20 DC B8 B0 EC E6 44 A5 44 C9 23 4C

; Track $00, sector $9
    HEX     C8 BF 90 05 A0 0D 91 48 38 BD 88 C0 60 A9 00 85
    ...
    HEX     0E 0C 0A 08 06 04 02 0F F0 0E C9 12 A9 70 B0 02
    HEX     A9 A0 20 A8 FC 4C D4 BE 18 4C 09 BF 8D 63 AA 8D
    HEX     70 AA 8D 71 AA 60 20 5B A7 8C B7 AA 60 20 7E AE
    HEX     AE 9B B3 9A 20 16 A3 BA 8E 9B B3 A9 09 4C 85 B3

; Track $00, sector $C
    HEX     D3 9C 81 9E BD 9E 75 AA 93 AA 60 AA 00 9D BB B5
    HEX     EA 9E 11 9F 22 9F 2E 9F 51 9F 60 9F 70 9F 4E A5
    HEX     12 A4 96 A3 D0 A4 EF A4 62 A2 70 A2 74 A2 E9 A2
    HEX     1A A5 C5 A5 0F A5 DC A5 A2 A2 97 A2 80 A2 6D A5
    HEX     32 A2 3C A2 28 A2 2D A2 50 A2 79 A5 9D A5 30 A3
    HEX     6B A3 8D A3 7C A2 FC A4 FC A4 65 D8 00 E0 3C D4
    HEX     F2 D4 36 E8 E5 A4 E3 E3 00 E0 03 E0 FC A4 FC A4
    HEX     65 D8 00 E0 3C D4 F2 D4 06 A5 06 A5 67 10 84 9D
    HEX     3C 0C F2 0C AD E9 B7 4A 4A 4A 4A 8D 6A AA AD EA
    HEX     B7 8D 68 AA AD 00 E0 49 20 D0 11 8D B6 AA A2 0A
    HEX     BD 61 9D 9D 55 9D CA D0 F7 4C BC 9D A9 40 8D B6
    HEX     AA A2 0C BD 6B 9D 9D 55 9D CA D0 F7 38 B0 12 AD
    HEX     B6 AA D0 04 A9 20 D0 05 0A 10 05 A9 4C 20 B2 A5
    HEX     18 08 20 51 A8 A9 00 8D 5E AA 8D 52 AA 28 6A 8D
    HEX     51 AA 30 03 6C 5E 9D 6C 5C 9D 0A 10 19 8D B6 AA
    HEX     A2 0C BD 77 9D 9D 55 9D CA D0 F7 A2 1D BD 93 AA

; Track $00, sector $D
    HEX     9D 75 AA CA 10 F7 AD B1 AA 8D 57 AA 20 D4 A7 AD
    HEX     B3 AA F0 09 48 20 9D A6 68 A0 00 91 40 20 5B A7
    HEX     AD 5F AA D0 20 A2 2F BD 51 9E 9D D0 03 CA 10 F7
    HEX     AD 53 9E 8D F3 03 49 A5 8D F4 03 AD 52 9E 8D F2
    HEX     03 A9 34 D0 05 AD 62 AA F0 06 8D 5F AA 4C 80 A1
    HEX     60 4C BF 9D 4C 84 9D 4C FD AA 4C B5 B7 AD 0F 9D
    HEX     AC 0E 9D 60 AD C2 AA AC C1 AA 60 4C 51 A8 EA EA
    HEX     4C 59 FA 4C 65 FF 48 B1 28 29 3F 91 28 68 6C 38
    HEX     00 20 D1 9E AD 51 AA F0 15 48 AD 5C AA 91 28 68
    HEX     30 03 4C 26 A6 20 EA 9D A4 24 A9 60 91 28 AD B3
    HEX     AA F0 03 20 82 A6 A9 03 8D 52 AA 20 BA 9F 20 BA
    HEX     9E 8D 5C AA 8E 5A AA 4C B3 9F 4C 76 9E 20 D1 9E
    HEX     AD 52 AA 0A AA BD 11 9D 48 BD 10 9D 48 AD 5C AA
    HEX     60 8D 5C AA 8E 5A AA 8C 5B AA BA E8 E8 8E 59 AA
    HEX     A2 03 BD 53 AA 95 36 CA 10 F8 60 AE B7 AA F0 03
    HEX     4C 78 9F AE 51 AA F0 08 C9 BF F0 75 C5 33 F0 27

; Track $00, sector $E
    HEX     A2 02 8E 52 AA CD B2 AA D0 19 CA 8E 52 AA CA 8E
    HEX     5D AA AE 5D AA 9D 00 02 E8 8E 5D AA C9 8D D0 75
    HEX     4C CD 9F C9 8D D0 7D A2 00 8E 52 AA 4C A4 9F A2
    HEX     00 8E 52 AA C9 8D F0 07 AD B3 AA F0 67 D0 5E 48
    HEX     38 AD B3 AA D0 03 20 5E A6 68 90 EC AE 5A AA 4C
    HEX     15 9F C9 8D D0 05 A9 05 8D 52 AA 20 0E A6 4C 99
    HEX     9F CD B2 AA F0 85 C9 8A F0 F1 A2 04 8E 52 AA D0
    HEX     E1 A9 00 8D 52 AA F0 25 A9 00 8D B7 AA 20 51 A8
    HEX     4C DC A4 AD 00 02 CD B2 AA F0 0A A9 8D 8D 00 02
    HEX     A2 00 8E 5A AA A9 40 D0 06 A9 10 D0 02 A9 20 2D
    HEX     5E AA F0 0F 20 BA 9F 20 C5 9F 8D 5C AA 8C 5B AA
    HEX     8E 5A AA 20 51 A8 AE 59 AA 9A AD 5C AA AC 5B AA
    HEX     AE 5A AA 38 60 6C 36 00 A9 8D 4C C5 9F A0 FF 8C
    HEX     5F AA C8 8C 62 AA EE 5F AA A2 00 08 BD 00 02 CD
    HEX     B2 AA D0 01 E8 8E 5D AA 20 A4 A1 29 7F 59 84 A8
    HEX     C8 0A F0 02 68 08 90 F0 28 F0 20 B9 84 A8 D0 D6

; Track $00, sector $F
    HEX     AD 00 02 CD B2 AA F0 03 4C A4 9F AD 01 02 C9 8D
    HEX     D0 06 20 5B A7 4C 95 9F 4C C4 A6 0E 5F AA AC 5F
    HEX     AA 20 5E A6 90 0C A9 02 39 09 A9 F0 05 A9 0F 4C
    HEX     D2 A6 C0 06 D0 02 84 33 A9 20 39 09 A9 F0 61 20
    HEX     95 A0 08 20 A4 A1 F0 1E 0A 90 05 30 03 4C 00 A0
    HEX     6A 4C 59 A0 20 93 A1 F0 0D 99 75 AA C8 C0 3C 90
    HEX     F3 20 93 A1 D0 FB 28 D0 0F AC 5F AA A9 10 39 09
    HEX     A9 F0 0C A0 1E 08 D0 CB AD 93 AA C9 A0 F0 13 AD
    HEX     75 AA C9 A0 D0 4B AC 5F AA A9 C0 39 09 A9 F0 02
    HEX     10 3F 4C 00 A0 A0 3C A9 A0 99 74 AA 88 D0 FA 60
    HEX     8D 75 AA A9 0C 39 09 A9 F0 27 20 B9 A1 B0 1F A8
    HEX     D0 17 E0 11 B0 13 AC 5F AA A9 08 39 09 A9 F0 06
    HEX     E0 08 B0 CE 90 0B 8A D0 08 A9 02 4C D2 A6 4C C4
    HEX     A6 A9 00 8D 65 AA 8D 74 AA 8D 66 AA 8D 6C AA 8D
    HEX     6D AA 20 DC BF AD 5D AA 20 A4 A1 D0 1F C9 8D D0
    HEX     F7 AE 5F AA AD 65 AA 1D 0A A9 5D 0A A9 D0 93 AE
